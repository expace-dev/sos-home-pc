				...
				$form.attr('novalidate', 'novalidate').ajaxForm({
					...
					beforeSubmit: function (arr, $form, options) {
						...
						if (isValidated(inputs, captcha)) {
							...
							if (output.hasClass("snackbars")) {
								output.html('<p><span class="icon text-middle fa fa-circle-o-notch fa-spin icon-xxs"></span><span>Veuillez patienter, traitement en cours...</span></p>');
								output.addClass("active");
							}
						} else {
							return false;
					...
					error: function (result) {
						...
						//console.log(result.responseJSON.errors.email);
						//document.location.href="/login";

						//$("#resultat").html("je fais un teste");

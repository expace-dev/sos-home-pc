...
class PaiementController extends AbstractController
{
    ...
    #[Route('/paiement/webhook/', name: 'app_paiement_webhook', methods:['POST', 'GET'])]
    ...
    #[Route('/paiement/error/', name: 'app_paiement_error', methods:['GET'])]
    ...
    public function index(Factures $facture, FacturesRepository $facturesRepository)
    {
